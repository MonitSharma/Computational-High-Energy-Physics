...
1.training.csv - all features

2.check_agreement.csv - all features besides mass for agreement check

3.check_correlation.csv - all features for correlation check

4.test.csv - all features besides mass

## Goal
The goal is to design prediction model that will give best score (ROC AUC) and will meet the constraints of

1.similar performance on simulated and real data (agreement check)
2.decorrelation with the mass (correlation check)
3.the predictions over test.csv (i.e. submission file) should be sent to coursera for evaluation.
